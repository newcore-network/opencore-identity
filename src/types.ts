...
export interface IdentityOptions {
  ...
  auth: {
    ...
    /**
     * API authentication configuration (only used in auth.mode = 'api').
     */
    api?: {
      /** Base URL for auth endpoints (e.g. https://auth.example.com) */
      baseUrl: string;

      /** Path for login/authentication (default: /auth) */
      authPath?: string;

      /** Path for registration (default: /register) */
      registerPath?: string;

      /** Path for session validation (default: /session) */
      sessionPath?: string;

      /** Path for logout (default: /logout) */
      logoutPath?: string;
  ...
  principal: {
    ...
    /**
     * API principal configuration (only used in principal.mode = 'api').
     */
    api?: {
      /** Base URL for principal endpoint (e.g. https://auth.example.com) */
      baseUrl: string;

      /** Path for principal resolution (default: /principal) */
